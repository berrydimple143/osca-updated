...
/* harmony export */   "default": () => (/* binding */ Religion),
...
function Religion({ info , details  }) {
    ...
    const [page, setPage] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)("religions");
    ...
    const [catholic, setCatholic] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [iglesia, setIglesia] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [baptist, setBaptist] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [adventist, setAdventist] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [jil, setJil] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [coc, setCoc] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [victory, setVictory] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [buddhist, setBuddhist] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [methodist, setMethodist] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [islam, setIslam] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [others, setOthers] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [catholicData, setCatholicData] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [iglesiaData, setIglesiaData] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [baptistData, setBaptistData] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [adventistData, setAdventistData] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [jilData, setJilData] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [cocData, setCocData] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [victoryData, setVictoryData] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [buddhistData, setBuddhistData] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [methodistData, setMethodistData] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [islamData, setIslamData] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [othersData, setOthersData] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    ...
    const generateData = async ()=>{
        setLoading(true);
        const { data  } = await (0,_services_reportService__WEBPACK_IMPORTED_MODULE_16__/* .generateMemberReport */ .d0)(typeValue, dateFrom, dateTo, municipality, "religions", userId);
...
var __webpack_exports__ = __webpack_require__.X(0, [747,9850,9086,5120,8581,5040], () => (__webpack_exec__(1167)));
