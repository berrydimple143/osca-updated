...
/* harmony export */   "default": () => (/* binding */ Classification),
...
function Classification({ info , details  }) {
    ...
    const [page, setPage] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)("classifications");
    ...
    const [indigent, setIndigent] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [pensioner, setPensioner] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [supported, setSupported] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [pwd, setPwd] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [indigentData, setIndigentData] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [pensionerData, setPensionerData] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [supportedData, setSupportedData] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [pwdData, setPwdData] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    ...
    const generateData = async ()=>{
        setLoading(true);
        const { data  } = await (0,_services_reportService__WEBPACK_IMPORTED_MODULE_16__/* .generateMemberReport */ .d0)(typeValue, dateFrom, dateTo, municipality, "classifications", userId);
...
var __webpack_exports__ = __webpack_require__.X(0, [747,9850,9086,5120,8581,5040], () => (__webpack_exec__(6534)));
