...
/* harmony export */   "default": () => (/* binding */ Gender),
...
function Gender({ info , details  }) {
    ...
    const [page, setPage] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)("genders");
    ...
    const [male, setMale] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [female, setFemale] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [maleData, setMaleData] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [femaleData, setFemaleData] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    ...
    const generateData = async ()=>{
        setLoading(true);
        const { data  } = await (0,_services_reportService__WEBPACK_IMPORTED_MODULE_16__/* .generateMemberReport */ .d0)(typeValue, dateFrom, dateTo, municipality, "genders", userId);
...
var __webpack_exports__ = __webpack_require__.X(0, [747,9850,9086,5120,8581,5040], () => (__webpack_exec__(7016)));
