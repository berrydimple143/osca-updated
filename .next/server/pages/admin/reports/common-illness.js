...
/* harmony export */   "default": () => (/* binding */ CommonIllness),
...
function CommonIllness({ info , details  }) {
    ...
    const [page, setPage] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)("illness");
    ...
    const [arthritis, setArthritis] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [alzheimer, setAlzheimer] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [cancer, setCancer] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [kidney, setKidney] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [pulmonary, setPulmonary] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [heart, setHeart] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [cholesterol, setCholesterol] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [pneumonia, setPneumonia] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [diabetes, setDiabetes] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [osteoporosis, setOsteoporosis] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [otherIllness, setOtherIllness] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [arthritisData, setArthritisData] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [alzheimerData, setAlzheimerData] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [cancerData, setCancerData] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [kidneyData, setKidneyData] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [pulmonaryData, setPulmonaryData] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [heartData, setHeartData] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [cholesterolData, setCholesterolData] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [pneumoniaData, setPneumoniaData] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [diabetesData, setDiabetesData] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [osteoporosisData, setOsteoporosisData] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [otherIllnessData, setOtherIllnessData] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    ...
    const generateData = async ()=>{
        setLoading(true);
        const { data  } = await (0,_services_reportService__WEBPACK_IMPORTED_MODULE_16__/* .generateMemberReport */ .d0)(typeValue, dateFrom, dateTo, municipality, "illness", userId);
...
var __webpack_exports__ = __webpack_require__.X(0, [747,9850,9086,5120,8581,5040], () => (__webpack_exec__(4482)));
