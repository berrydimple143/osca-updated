...
/* harmony export */   "default": () => (/* binding */ Employment),
...
function Employment({ info , details  }) {
    ...
    const [page, setPage] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)("employments");
    ...
    const [selfEmployed, setSelfEmployed] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [unemployed, setUnemployed] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [employed, setEmployed] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [reportGraphLabels, setReportGraphLabels] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [employedData, setEmployedData] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [unemployedData, setUnemployedData] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [selfEmployedData, setSelfEmployedData] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    ...
    const generateData = async ()=>{
        setLoading(true);
        const { data  } = await (0,_services_reportService__WEBPACK_IMPORTED_MODULE_16__/* .generateMemberReport */ .d0)(typeValue, dateFrom, dateTo, municipality, "employments", userId);
    ...
    const getSeniorStatuses = async ()=>{
        const { data  } = await (0,_services_reportService__WEBPACK_IMPORTED_MODULE_16__/* .getEmploymentStatuses */ .Ek)();
...
var __webpack_exports__ = __webpack_require__.X(0, [747,9850,9086,5120,8581,5040], () => (__webpack_exec__(9102)));
