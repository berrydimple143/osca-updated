...
function Education({ info , details  }) {
    ...
    const [page, setPage] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)("education");
    ...
    const [elementary, setElementary] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [highSchool, setHighSchool] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [college, setCollege] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [vocational, setVocational] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [masterDegree, setMasterDegree] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [doctoral, setDoctoral] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [elementaryData, setElementaryData] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [highSchoolData, setHighSchoolData] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [collegeData, setCollegeData] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [vocationalData, setVocationalData] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [masterDegreeData, setMasterDegreeData] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [doctoralData, setDoctoralData] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    ...
    const generateData = async ()=>{
        setLoading(true);
        const { data  } = await (0,_services_reportService__WEBPACK_IMPORTED_MODULE_16__/* .generateMemberReport */ .d0)(typeValue, dateFrom, dateTo, municipality, "education", userId);
...
var __webpack_exports__ = __webpack_require__.X(0, [747,9850,9086,5120,8581,5040], () => (__webpack_exec__(899)));
